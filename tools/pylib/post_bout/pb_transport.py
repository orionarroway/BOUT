...
class Transport(LinRes):
    def __init__(self,alldb):
        LinRes.__init__(self,alldb)

    def plotnlrms(self,pp,field='vEBrms',yscale='log',clip=0,
        ...
        for j in list(set(Modes.path).union()):
            ...
            ax.set_ylabel(r'$\frac{V_{EB}}{ddt}$',fontsize=12,rotation='horizontal')
            k+=1
